  ...
  db.collection("goals")
    ...
    .onSnapshot((doc) => {
      ...
      var moduleContainData = '<div class="module"><div class="heading m_head"><h4>'+data['goalname']+'</h4> <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none" /> <path fill="rgba(255, 255, 255, 0.6)" d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"/></svg></div></div><!-- <div class="module_data"> -->';
        ...
        var add = '<div style="display: flex; flex-direction: column;" class="row" ><div class="col">Demo Lecture</div><div style="display: flex;-direction: row;border-top: 1px solid #454545;overflow-x: scroll;justify-content: center;align-items: center;padding-top:0.5rem;" class="col" ><video width="200" height="100" controls><source src="http://techslides.com/demos/sample-videos/small.mp4" type="video/mp4" /></video><a target="_Blank" href="http://www.africau.edu/images/default/sample.pdf" style=" padding: 0.5rem;text-decoration: none; color: white; background: purple; border-radius: 5px;  display: grid;place-items: center;text-align: center;height: 50px;">Download Notes</a></div></div>';
